namespace TenjinX.Tools.Applications.CodeGenerators.MimeTypes.Constants;
...
public static class CodeSnippets
{
    ...
    public const string TestFileExtensionToMimeTypeTestCaseTemplate = "[InlineData(\"FILE_EXTENSION\", \"MIME_TYPE\")]\r\n";
    public const string TestMimeTypeToFileExtensionTestCaseTemplate = "[InlineData(\"MIME_TYPE\", \"FILE_EXTENSION\")]\r\n";
    public const string TestMimeTypeToFileExtensionsTestCaseTemplate = "[InlineData(\"MIME_TYPE\", new[] { CODE_SNIPPET })]\r\n";
}